...
# 2021-09-11 Created file from GAFF version specifically for OPLS prep.
...
FF=o                            # Forcefield options: g (GAFF), o (OPLSAA, default), a (AMBER 14SB)

######################## NO MORE EDITING PAST THIS LINE! ###################################

# Activate GROMACS libraries (on Sherlock)
#ml reset
